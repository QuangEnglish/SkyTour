            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/LoaiDanhMuc.html">Loại danh mục</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/SanPham.html">Sản Phẩm</a></li>
